...
public class Dao 
{
    ...
    public Search_Board search_board(String tag) //stop
    {
    	
    	Search_Board sb = new Search_Board();
        ...
        try {
                ...
                while(rs.next())
                {
                        sb.setBoard_Num(rs.getInt(1));
                        sb.setContent(rs.getString(2));
                        sb.setDate_Board(rs.getString(3));
                        sb.setGood(rs.getInt(4));
                        sb.setBoard_Latitude(rs.getDouble(5));
                        sb.setBoard_Longitude(rs.getDouble(6));
                        sb.setUser_Id(rs.getString(7));
                        
                        if(rs.getString(8).equals("No Photo"))
                        {
                        	sb.setUser_Photo(rs.getString(8));
                        }
                        else
                        {
                        	sb.setUser_Photo(path+"PlitImage/"+rs.getString(8));
                        }
 ...
 //=========================================================================
    ...
    public Load_Locate load_locate(String id)
    {
    	
    	Load_Locate ll = new Load_Locate();
   ...
   //=======================================================================
    ...
    public Read_Mypage read_myPage(String user_name)
    {
    	...
    	try {                                                                                                                                                                                 
    		...
    		read_board.setUser_Id(rs.getString(1));
    		read_board.setDate_Birth(rs.getString(3));
    		read_board.setDate_Member(rs.getString(4));
    		
    		if(rs.getString(5).equals("No Photo"))
    		{
    			read_board.setUser_Photo(rs.getString(5));
    		}
    		else
			{
    			read_board.setUser_Photo(path+"PlitImage/"+rs.getString(5));
			}
   ...
   //=======================================================================
    ...
    public Read_Myboard read_myboard(String user_name,int limit)
    {
    	Read_Myboard read_myboard = new Read_Myboard();
    	...
    	try {                                                                                                                                                                                 
    		...
    		while(rs.next())
    		{
    			read_myboard.setBoard_Num(rs.getInt(1));
    			read_myboard.setContent(rs.getString(2));
    			read_myboard.setDate_Board(rs.getString(3));
    			read_myboard.setGood(rs.getInt(4));
    			read_myboard.setLatitude(rs.getDouble(5));
    			read_myboard.setLongitude(rs.getDouble(6));
    			read_myboard.setUser_Id(rs.getString(7));
    			
    			if(rs.getString(8).equals("No Photo"))
    			{
    				read_myboard.setUser_Photo(rs.getString(8));
    			}
    			else
    			{
    				read_myboard.setUser_Photo(path+"PlitImage/"+rs.getString(8));
    			}
    			read_myboard.setCategory(rs.getInt(9));
    			read_myboard.setComment_Cnt(rs.getInt(10));
    		}
   //=======================================================================
    	} catch ( SQLException e ) {
    ...
    public ArrayList<Read_Board_List> read_board_List()
    {
    	...
    	try {                                                                                                                                                                                 
    		...
    		while(rs.next())
    		{
    			...
    			rbl.setBoard_Num(rs.getInt(1));
    			rbl.setContent(rs.getString(2));
    			rbl.setDate_Board(rs.getString(3));
    			rbl.setGood(rs.getInt(4));
    			rbl.setBoard_Latitude(rs.getDouble(5));
    			rbl.setBoard_Longitude(rs.getDouble(6));
    			rbl.setUser_Id(rs.getString(7));
    			
    			if(rs.getString(8).equals("No Photo"))
    			{
    				rbl.setUser_Photo(rs.getString(8));
    			}
    			else
    			{
    				rbl.setUser_Photo(path+"PlitImage/"+rs.getString(8));
    			}  			
    			rbl.setCategory(rs.getInt(9));
    			rbl.setComment_Cnt(rs.getInt(10));
    ...
    public Read_Board_Location read_board_location(double min_lat,double max_lat,double min_lon,double max_lon)
    {
    	...
    	try {                                                                                                                                                                                 
    		...
    		while(rs.next())
    		{
    			...
    			while(res.next())
    			{
    				rb_location.setBoard_Num(res.getInt(1));
    				rb_location.setContent(res.getString(2));
    				rb_location.setId(res.getString(3));
    				
        			if(res.getString(4).equals("No Photo"))
        			{
        				rb_location.setUser_Photo(res.getString(4));
        			}
        			else
        			{
        				rb_location.setUser_Photo(path+"PlitImage/"+res.getString(4));
        			}  	
    				...
    				if(tres.next())
    				{
    					...
    					rb_location.setPhoto_Count(tres.getInt(1));
    					rb_location.setBoard_Photo(path+"PlitImage/"+tres.getString(2));
    				}
    				else
    				{
    					rb_location.setIs_Photo(0);
    				}
    				
    			}
    			rb_location.setBoard_Latitude(rs.getDouble(1));
    			rb_location.setBoard_Longitude(rs.getDouble(2));
    			rb_location.setBoard_Count(rs.getInt(3));
   ...
   //=======================================================================
    ...
    public Read_Friends read_friends(String user_name)
    {
    	Read_Friends rf = new Read_Friends();
   ...
   //=======================================================================
    ...
    public Read_Comment read_comment(String board_num)
    {
    	Read_Comment rc = new Read_Comment();
    	...
    	try {                                                                                                                                                                                 
    		...
    		while(rs.next())
    		{
    			...
    			rc.setBoard_Num(rs.getInt(1));
    			rc.setComment_Num(rs.getInt(2));
    			rc.setComment_Date(rs.getString(3));
    			rc.setComment_Content(rs.getString(4));
    			rc.setComment_Id(rs.getString(5));
    			
    			if(rs.getString(6).equals("No Photo"))
    			{
    				rc.setUser_Photo(rs.getString(6));
    			}
    			else
    			{
    				rc.setUser_Photo(path+"PlitImage/"+rs.getString(6));
    			}
   ...
   //=======================================================================
    ...
    {	
    	...
    	Read_Board_Info rbi = new Read_Board_Info();
    	...
    	try {                                                                                                                                                                                 
    		...
    		rbi.setUser_Id(rs.getString(8));
    	
    		if(rs.getString(9).equals("No Photo"))
			{
    			rbi.setUser_Photo(rs.getString(9));
			}
			else
			{
				rbi.setUser_Photo(path+"PlitImage/"+rs.getString(9));
			}
    		if(check_good(board_num,user_name)==0)
    		{
    			rbi.setIs_Good(1);
    		...
    		pstmt = conn.prepareStatement("SELECT * FROM board_photo WHERE board_num = ?;");
    		pstmt.setInt(1,rbi.getBoard_Num());
    		rs = pstmt.executeQuery();
    		
    		while(rs.next())
    		{
    			System.out.println("RBI : jrr start");
    			rbi.setUser_Photo((path+"PlitImage/"+rs.getString(2)));
    			System.out.println("RBI : jrr end");
    		}
